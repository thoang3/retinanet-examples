python retinanet/main.py train retinanet_rn50fpn.pth --backbone ResNet50FPN --lr 0.005 --batch 2 --warmup 5000 --iter 480000  --logdir log --milestones 420000 448000 \
